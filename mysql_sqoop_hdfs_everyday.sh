...
APP=gmall
sqoop=/home/hadoop/app/sqoop/bin/sqoop
...
import_data(){
$sqoop import \
--connect jdbc:mysql://slave2:3306/$APP \
--username root \
--password root \
...
hadoop jar /home/hadoop/app/hadoop/share/hadoop/common/hadoop-lzo-0.4.21-SNAPSHOT.jar com.hadoop.compression.lzo.DistributedLzoIndexer /origin_data/$APP/db/$1/$do_date
}
