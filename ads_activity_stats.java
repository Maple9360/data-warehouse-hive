...
//
// Debug information:
// Generated date: Fri Jun 24 22:16:54 CST 2022
...
public class ads_activity_stats extends SqoopRecord  implements DBWritable, Writable {
  ...
  private void init0() {
    setters.put("activity_id", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        ads_activity_stats.this.activity_id = (String)value;
      }
    });
    setters.put("activity_name", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        ads_activity_stats.this.activity_name = (String)value;
      }
    });
    setters.put("dt", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        ads_activity_stats.this.dt = (java.sql.Date)value;
      }
    });
    setters.put("order_count", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        ads_activity_stats.this.order_count = (Long)value;
      }
    });
    setters.put("order_final_amount", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        ads_activity_stats.this.order_final_amount = (java.math.BigDecimal)value;
      }
    });
    setters.put("order_original_amount", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        ads_activity_stats.this.order_original_amount = (java.math.BigDecimal)value;
      }
    });
    setters.put("reduce_amount", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        ads_activity_stats.this.reduce_amount = (java.math.BigDecimal)value;
      }
    });
    setters.put("reduce_rate", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        ads_activity_stats.this.reduce_rate = (java.math.BigDecimal)value;
      }
    });
    setters.put("start_date", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        ads_activity_stats.this.start_date = (java.sql.Date)value;
      }
    });
  }
  public ads_activity_stats() {
    init0();
  }
  ...
  public void readFields(ResultSet __dbResults) throws SQLException {
    ...
    this.activity_id = JdbcWritableBridge.readString(1, __dbResults);
    this.activity_name = JdbcWritableBridge.readString(2, __dbResults);
    this.dt = JdbcWritableBridge.readDate(3, __dbResults);
    this.order_count = JdbcWritableBridge.readLong(4, __dbResults);
    ...
    this.reduce_amount = JdbcWritableBridge.readBigDecimal(7, __dbResults);
    this.reduce_rate = JdbcWritableBridge.readBigDecimal(8, __dbResults);
    this.start_date = JdbcWritableBridge.readDate(9, __dbResults);
  }
  ...
  public int write(PreparedStatement __dbStmt, int __off) throws SQLException {
    JdbcWritableBridge.writeString(activity_id, 1 + __off, 12, __dbStmt);
    JdbcWritableBridge.writeString(activity_name, 2 + __off, 12, __dbStmt);
    JdbcWritableBridge.writeDate(dt, 3 + __off, 91, __dbStmt);
    JdbcWritableBridge.writeLong(order_count, 4 + __off, -5, __dbStmt);
    ...
    JdbcWritableBridge.writeBigDecimal(reduce_amount, 7 + __off, 3, __dbStmt);
    JdbcWritableBridge.writeBigDecimal(reduce_rate, 8 + __off, 3, __dbStmt);
    JdbcWritableBridge.writeDate(start_date, 9 + __off, 91, __dbStmt);
    return 9;
  }
