...
//
// Debug information:
// Generated date: Fri Jun 24 22:23:23 CST 2022
...
public class ads_order_spu_stats extends SqoopRecord  implements DBWritable, Writable {
  ...
  private void init0() {
    setters.put("category1_id", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        ads_order_spu_stats.this.category1_id = (String)value;
      }
    });
    setters.put("category1_name", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        ads_order_spu_stats.this.category1_name = (String)value;
      }
    });
    setters.put("category2_id", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        ads_order_spu_stats.this.category2_id = (String)value;
      }
    });
    setters.put("category2_name", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        ads_order_spu_stats.this.category2_name = (String)value;
      }
    });
    setters.put("category3_id", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        ads_order_spu_stats.this.category3_id = (String)value;
      }
    });
    setters.put("category3_name", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        ads_order_spu_stats.this.category3_name = (String)value;
      }
    });
    setters.put("dt", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        ads_order_spu_stats.this.dt = (java.sql.Date)value;
      }
    });
    setters.put("order_amount", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        ads_order_spu_stats.this.order_amount = (java.math.BigDecimal)value;
      }
    });
    setters.put("order_count", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        ads_order_spu_stats.this.order_count = (Long)value;
      }
    });
    setters.put("recent_days", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        ads_order_spu_stats.this.recent_days = (Long)value;
      }
    });
    setters.put("spu_id", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        ads_order_spu_stats.this.spu_id = (String)value;
      }
    });
    setters.put("spu_name", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        ads_order_spu_stats.this.spu_name = (String)value;
      }
    });
    setters.put("tm_id", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        ads_order_spu_stats.this.tm_id = (String)value;
      }
    });
    setters.put("tm_name", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        ads_order_spu_stats.this.tm_name = (String)value;
      }
    });
  }
  public ads_order_spu_stats() {
    init0();
  }
  ...
  public void readFields(ResultSet __dbResults) throws SQLException {
    ...
    this.category1_id = JdbcWritableBridge.readString(1, __dbResults);
    this.category1_name = JdbcWritableBridge.readString(2, __dbResults);
    this.category2_id = JdbcWritableBridge.readString(3, __dbResults);
    this.category2_name = JdbcWritableBridge.readString(4, __dbResults);
    this.category3_id = JdbcWritableBridge.readString(5, __dbResults);
    this.category3_name = JdbcWritableBridge.readString(6, __dbResults);
    this.dt = JdbcWritableBridge.readDate(7, __dbResults);
    this.order_amount = JdbcWritableBridge.readBigDecimal(8, __dbResults);
    this.order_count = JdbcWritableBridge.readLong(9, __dbResults);
    this.recent_days = JdbcWritableBridge.readLong(10, __dbResults);
    this.spu_id = JdbcWritableBridge.readString(11, __dbResults);
    this.spu_name = JdbcWritableBridge.readString(12, __dbResults);
    this.tm_id = JdbcWritableBridge.readString(13, __dbResults);
    this.tm_name = JdbcWritableBridge.readString(14, __dbResults);
  }
  ...
  public int write(PreparedStatement __dbStmt, int __off) throws SQLException {
    JdbcWritableBridge.writeString(category1_id, 1 + __off, 12, __dbStmt);
    JdbcWritableBridge.writeString(category1_name, 2 + __off, 12, __dbStmt);
    JdbcWritableBridge.writeString(category2_id, 3 + __off, 12, __dbStmt);
    JdbcWritableBridge.writeString(category2_name, 4 + __off, 12, __dbStmt);
    JdbcWritableBridge.writeString(category3_id, 5 + __off, 12, __dbStmt);
    JdbcWritableBridge.writeString(category3_name, 6 + __off, 12, __dbStmt);
    JdbcWritableBridge.writeDate(dt, 7 + __off, 91, __dbStmt);
    JdbcWritableBridge.writeBigDecimal(order_amount, 8 + __off, 3, __dbStmt);
    JdbcWritableBridge.writeLong(order_count, 9 + __off, -5, __dbStmt);
    JdbcWritableBridge.writeLong(recent_days, 10 + __off, -5, __dbStmt);
    JdbcWritableBridge.writeString(spu_id, 11 + __off, 12, __dbStmt);
    JdbcWritableBridge.writeString(spu_name, 12 + __off, 12, __dbStmt);
    JdbcWritableBridge.writeString(tm_id, 13 + __off, 12, __dbStmt);
    JdbcWritableBridge.writeString(tm_name, 14 + __off, 12, __dbStmt);
    return 14;
  }
