...
//
// Debug information:
// Generated date: Fri Jun 24 22:24:10 CST 2022
...
public class ads_order_total extends SqoopRecord  implements DBWritable, Writable {
  ...
  private void init0() {
    setters.put("dt", new FieldSetterCommand() {
      ...
      public void setField(Object value) {
        ads_order_total.this.dt = (java.sql.Date)value;
      }
    });
    setters.put("order_amount", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        ads_order_total.this.order_amount = (java.math.BigDecimal)value;
      }
    });
    setters.put("order_count", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        ads_order_total.this.order_count = (Long)value;
      }
    });
    setters.put("order_user_count", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        ads_order_total.this.order_user_count = (Long)value;
      }
    });
    setters.put("recent_days", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        ads_order_total.this.recent_days = (Long)value;
      }
    });
  }
  public ads_order_total() {
    init0();
  }
  ...
  public void readFields(ResultSet __dbResults) throws SQLException {
    ...
    this.order_amount = JdbcWritableBridge.readBigDecimal(2, __dbResults);
    ...
    this.recent_days = JdbcWritableBridge.readLong(5, __dbResults);
  }
  ...
  public int write(PreparedStatement __dbStmt, int __off) throws SQLException {
    ...
    JdbcWritableBridge.writeBigDecimal(order_amount, 2 + __off, 3, __dbStmt);
    ...
    JdbcWritableBridge.writeLong(recent_days, 5 + __off, -5, __dbStmt);
    return 5;
  }
