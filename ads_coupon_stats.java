...
//
// Debug information:
// Generated date: Fri Jun 24 22:21:44 CST 2022
...
public class ads_coupon_stats extends SqoopRecord  implements DBWritable, Writable {
  ...
  private void init0() {
    setters.put("coupon_id", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        ads_coupon_stats.this.coupon_id = (String)value;
      }
    });
    setters.put("coupon_name", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        ads_coupon_stats.this.coupon_name = (String)value;
      }
    });
    setters.put("dt", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        ads_coupon_stats.this.dt = (java.sql.Date)value;
      }
    });
    setters.put("expire_count", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        ads_coupon_stats.this.expire_count = (Long)value;
      }
    });
    setters.put("get_count", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        ads_coupon_stats.this.get_count = (Long)value;
      }
    });
    setters.put("order_count", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        ads_coupon_stats.this.order_count = (Long)value;
      }
    });
    setters.put("order_final_amount", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        ads_coupon_stats.this.order_final_amount = (java.math.BigDecimal)value;
      }
    });
    setters.put("order_original_amount", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        ads_coupon_stats.this.order_original_amount = (java.math.BigDecimal)value;
      }
    });
    setters.put("reduce_amount", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        ads_coupon_stats.this.reduce_amount = (java.math.BigDecimal)value;
      }
    });
    setters.put("reduce_rate", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        ads_coupon_stats.this.reduce_rate = (java.math.BigDecimal)value;
      }
    });
    setters.put("rule_name", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        ads_coupon_stats.this.rule_name = (String)value;
      }
    });
    setters.put("start_date", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        ads_coupon_stats.this.start_date = (java.sql.Date)value;
      }
    });
  }
  public ads_coupon_stats() {
    init0();
  }
  ...
  public void readFields(ResultSet __dbResults) throws SQLException {
    ...
    this.coupon_id = JdbcWritableBridge.readString(1, __dbResults);
    this.coupon_name = JdbcWritableBridge.readString(2, __dbResults);
    this.dt = JdbcWritableBridge.readDate(3, __dbResults);
    this.expire_count = JdbcWritableBridge.readLong(4, __dbResults);
    this.get_count = JdbcWritableBridge.readLong(5, __dbResults);
    ...
    this.order_original_amount = JdbcWritableBridge.readBigDecimal(8, __dbResults);
    this.reduce_amount = JdbcWritableBridge.readBigDecimal(9, __dbResults);
    this.reduce_rate = JdbcWritableBridge.readBigDecimal(10, __dbResults);
    this.rule_name = JdbcWritableBridge.readString(11, __dbResults);
    this.start_date = JdbcWritableBridge.readDate(12, __dbResults);
  }
  ...
  public int write(PreparedStatement __dbStmt, int __off) throws SQLException {
    JdbcWritableBridge.writeString(coupon_id, 1 + __off, 12, __dbStmt);
    JdbcWritableBridge.writeString(coupon_name, 2 + __off, 12, __dbStmt);
    JdbcWritableBridge.writeDate(dt, 3 + __off, 91, __dbStmt);
    JdbcWritableBridge.writeLong(expire_count, 4 + __off, -5, __dbStmt);
    JdbcWritableBridge.writeLong(get_count, 5 + __off, -5, __dbStmt);
    ...
    JdbcWritableBridge.writeBigDecimal(order_original_amount, 8 + __off, 3, __dbStmt);
    JdbcWritableBridge.writeBigDecimal(reduce_amount, 9 + __off, 3, __dbStmt);
    JdbcWritableBridge.writeBigDecimal(reduce_rate, 10 + __off, 3, __dbStmt);
    JdbcWritableBridge.writeString(rule_name, 11 + __off, 12, __dbStmt);
    JdbcWritableBridge.writeDate(start_date, 12 + __off, 91, __dbStmt);
    return 12;
  }
